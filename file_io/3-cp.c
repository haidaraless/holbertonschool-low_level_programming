...
/**
* error_exit - a helper function to handle errors print and exit
*
...
/**
* error_exit_str - a helper function to print a message with string and exit
*
* @code: the exit code to return
* @msg: the error message to be printed
* @arg: a string of arguments for message
...
/**
* copy - a helper function to copy file content
*
